...
#import "CVActionSheetShareView.h"
#import <pop/POP.h>

#define MARGIN 8.0
#define CORNER_RADIUS 10.0
#define HEIGHT_BUTTON_DEFAULT 60
#define HEIGHT_LIST_DEFAULT 120
#define WIDTH_ITEM 70
#define FONT_SIZE_BUTTON_DEFAULT 20
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if(self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])
    {
        ...
        self.label.textColor = [UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:1.0];
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if(self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])
    {
        ...
        layout.sectionInset = UIEdgeInsetsMake(0.0f, getUIValue(20.0f), 0.0f, 0.0f);
...
- (instancetype)initWithFrame:(CGRect)frame
{
    if(self = [super initWithFrame:frame])
    {
        ...
        self.label.textColor = PurityColor(60);
        [self addSubview:self.label];
    }
...
@interface CVActionSheetShareView ()<UITableViewDataSource,UITableViewDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UIGestureRecognizerDelegate>
...
@implementation CVActionSheetShareView
...
- (void)show
{
    ...
    NSInteger nbRows = [self tableView:tableView numberOfRowsInSection:0];
...
- (void)hide
{
    ...
    // Remove
    [self.superview performSelector:@selector(removeFromSuperview) withObject:nil afterDelay:animPosY.duration];
}
...
- (void)initializeCancel
{
    ...
    self.cancelButton.titleLabel.font = [UIFont systemFontOfSize:FONT_SIZE_BUTTON_DEFAULT];
