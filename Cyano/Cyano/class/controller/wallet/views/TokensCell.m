...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        self.backgroundColor = PurityColor(242);
...
-(void)reloadCell:(MDOep4InfoModel*)model{
        _nameLB.text = model.Symbol;
        [_tokenImageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",model.Logo]]];
}
