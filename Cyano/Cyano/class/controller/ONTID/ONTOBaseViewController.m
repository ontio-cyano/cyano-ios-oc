...
-(void)viewWillDisappear:(BOOL)animated
{
    ...
    [self.navigationController.navigationBar setBackgroundImage:[EasyShowUtils imageWithColor:[UIColor colorWithHexString:@"#3bb4d0"]] forBarPosition:UIBarPositionAny barMetrics:UIBarMetricsDefault];
