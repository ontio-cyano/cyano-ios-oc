//
//  CTExportWalletViewController.m
//  Cyano
//
...
@interface CTExportWalletViewController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation CTExportWalletViewController
...
- (void)layoutHeaderView
{
    ...
    detailLabel.text = @"Here you have your address and private key. You can use them to restore your account.";
...
- (void)layoutTableView
{
    ...
    [self.customArray addObject:@"Address"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        cell.textView.text = [GCHRAM instance].defaultAccount.address;
    }
